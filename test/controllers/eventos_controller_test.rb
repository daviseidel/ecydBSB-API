...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference("Evento.count") do
      post eventos_url, params: { evento: { data: @evento.data, descricao: @evento.descricao, inscritos: @evento.inscritos, local: @evento.local, titulo: @evento.titulo } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { data: @evento.data, descricao: @evento.descricao, inscritos: @evento.inscritos, local: @evento.local, titulo: @evento.titulo } }
